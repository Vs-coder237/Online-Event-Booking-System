            ...
            try {
                $stmt = $pdo->prepare("
                    INSERT INTO events (
                        ...
                        price, total_tickets, available_tickets, image, status
                    ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                ");
                ...
                $stmt->execute([
                    $title, $description, $category_id, $venue_id, $organizer_name,
                    $organizer_email, $organizer_phone, $event_date, $start_time, $end_time,
                    $price, $total_tickets, $total_tickets, $image_filename, $status
                ]);

                $event_id = $pdo->lastInsertId();
                
                logActivity('event_created', "Event created: $title (ID: $event_id)", 'admin');
...
<head>
    ...
    <title>Add Event - Admin | <?php echo SITE_NAME; ?></title>
                ...
                <div class="row">
                                            ...
                                            <select class="form-select" id="venue_id" name="venue_id" required>
                                                ...
                                                <?php foreach ($venues as $venue): ?>
                                                    <option value="<?php echo $venue['id']; ?>" 
                                                            <?php echo ($_POST['venue_id'] ?? '') == $venue['id'] ? 'selected' : ''; ?>>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control" id="total_tickets" name="total_tickets" 
                                                   value="<?php echo $_POST['total_tickets'] ?? ''; ?>" 
                                                   min="1" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="organizer_name" name="organizer_name" 
                                                   value="<?php echo htmlspecialchars($_POST['organizer_name'] ?? ''); ?>" required>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="email" class="form-control" id="organizer_email" name="organizer_email" 
                                                   value="<?php echo htmlspecialchars($_POST['organizer_email'] ?? ''); ?>" required>
                                        </div>
                                        <div class="col-md-4">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title mb-0">
                                    <i class="fas fa-info-circle"></i> Event Guidelines
                                </h6>
                            </div>
                            <div class="card-body">
                                <ul class="list-unstyled mb-0">
                                    ...
                                    <li class="mb-2">
                                        <i class="fas fa-check text-success me-2"></i>
                                        Upload high-quality event image
                                    </li>
                                    <li class="mb-2">
                                        <i class="fas fa-check text-success me-2"></i>
                                        Set appropriate ticket pricing
                                    </li>
                                    <li class="mb-2">
                                        <i class="fas fa-check text-success me-2"></i>
                                    ...
                                    <li class="mb-0">
                                        <i class="fas fa-check text-success me-2"></i>
                                        Provide complete organizer details
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                <p class="small mb-2">If you need assistance with creating events, please contact the system administrator.</p>
